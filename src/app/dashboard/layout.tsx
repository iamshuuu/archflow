...
export default function DashboardLayout({
    ...
    // ─── Dark mode init ───
    useEffect(() => {
        const stored = localStorage.getItem("archflow-theme") as "light" | "dark" | null;
            ...
            <div style={{ display: "flex", minHeight: "100vh", background: "var(--bg-primary)" }}>
                ...
                {isMobile && mobileMenuOpen && (
                    <div
                        ...
                        style={{
                            ...
                            zIndex: 39, animation: "fadeIn 0.15s ease",
                        }}
                    />
                )}
                {/* Sidebar */}
                {showSidebar && <aside
                    style={{
                        ...
                        left: 0,
                        bottom: 0,
                        width: isMobile ? "280px" : `${collapsed ? 72 : 240}px`,
                        ...
                        zIndex: 40,
                        overflow: "hidden",
                        ...(isMobile ? { boxShadow: "4px 0 20px rgba(0,0,0,0.15)" } : {}),
                    }}
                >
                    {/* Logo */}
                    <div
                    ...
                    <div style={{ padding: collapsed ? "8px 8px 12px" : "8px 14px 12px", borderTop: "1px solid var(--border-primary)", display: "flex", flexDirection: "column", gap: "2px" }}>
                        ...
                        <button
                            ...
                            style={{
                                display: "flex", alignItems: "center", gap: "10px",
                                padding: (collapsed && !isMobile) ? "10px" : "10px 12px", borderRadius: "6px",
                                textDecoration: "none", justifyContent: (collapsed && !isMobile) ? "center" : "flex-start",
                                background: "transparent", border: "none", cursor: "pointer",
                                color: "var(--text-tertiary)", fontSize: "13px", fontWeight: 400,
                                fontFamily: "inherit", transition: "all 0.15s", width: "100%",
                            }}
                            onMouseEnter={(e) => { e.currentTarget.style.background = "var(--bg-warm)"; e.currentTarget.style.color = "var(--text-secondary)"; }}
                            onMouseLeave={(e) => { e.currentTarget.style.background = "transparent"; e.currentTarget.style.color = "var(--text-tertiary)"; }}
                        >
                            {theme === "light" ? <Moon size={18} style={{ flexShrink: 0 }} /> : <Sun size={18} style={{ flexShrink: 0 }} />}
                            {(!collapsed || isMobile) && (theme === "light" ? "Dark Mode" : "Light Mode")}
                        </button>
                    ...
                    {isMobile ? (
                        <button
                            ...
                            style={{
                                ...
                                justifyContent: "center", color: "var(--text-muted)", zIndex: 50,
                            }}
                        >
                            <X size={14} />
                        </button>
                ...
                <div style={{ flex: 1, marginLeft: `${sidebarWidth}px`, transition: "margin-left 0.25s ease", display: "flex", flexDirection: "column" }}>
                    ...
                    <header
                        style={{
                            ...
                            zIndex: 30,
                            height: "65px",
                            background: theme === "dark" ? "rgba(26,24,21,0.92)" : "rgba(250,248,245,0.92)",
                    ...
                    >
                        ...
                        {isMobile && (
                            <button
                                ...
                                style={{
                                    ...
                                    color: "var(--text-secondary)", marginRight: "12px", flexShrink: 0,
                                }}
                            >
                                <Menu size={16} />
                            </button>
                        ...
                        >
                            ...
                            {!isMobile && <kbd style={{ fontSize: "10px", color: "var(--text-muted)", background: "var(--bg-card)", border: "1px solid var(--border-primary)", borderRadius: "3px", padding: "1px 5px", fontFamily: "inherit" }}>⌘K</kbd>}
                        </div>
                    ...
                    {/* Page content */}
                    <main className="fade-in" style={{ flex: 1, padding: isMobile ? "16px" : "28px" }}>
                        {children}
                    </main>
                </div>
            </div>
